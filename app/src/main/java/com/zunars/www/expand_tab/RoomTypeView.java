...
public class RoomTypeView extends RelativeLayout implements ViewBaseAction{

	private ListView mListView;
	private final String[] items = new String[] { "不限", "一居","二居", "三居", "四居",  "四居以上" };//显示字段
	...
	public RoomTypeView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public RoomTypeView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
